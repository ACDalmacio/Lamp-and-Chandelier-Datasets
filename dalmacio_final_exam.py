...
Original file is located at
    https://colab.research.google.com/drive/1NKCQ0pz9j17Qm-koQ5GiVFFliAaCC7Jq

##FINAL EXAM: MODEL DEPLOYMENT IN THE CLOUD##
Name: Andre Christian G. Dalmacio <br>
Course and Section: CPE 019 - CPE32S5 <br>
Date of Submission: May 20, 2023 <br>
Instructor: Dr. Jonathan Taylar <br>
"""
...
dir = '/content/drive/MyDrive/Colab Notebooks/FINALS/lights'
...
Chandelier = '/content/drive/MyDrive/Colab Notebooks/FINALS/lights/chandelier/chandelier'
Lamp = '/content/drive/MyDrive/Colab Notebooks/FINALS/lights/lamp/lamp'


print("Number of Images per Class:\n")

print("Chandelier: {}".format(len(os.listdir(Chandelier))))
print("Lamp: {}".format(len(os.listdir(Lamp))))
...
X, y = make_train_dataset(Chandelier, "Chandelier")
X, y = make_train_dataset(Lamp, "Lamp")
...
filepath="/content/drive/MyDrive/Colab Notebooks/FINALS/Models/weights-improvement-{epoch:02d}-{val_accuracy:.2f}.hdf5"
checkpoint = ModelCheckpoint(filepath, monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
callbacks_list = [checkpoint]

modified_model().fit_generator(datagen.flow(X_train, y_train, batch_size=55),
                              epochs=10, validation_data=(X_test, y_test), callbacks=callbacks_list,
                              verbose=1, steps_per_epoch=X_train.shape[0] // 55)

from tensorflow.keras.models import load_model

# run the test harness for evaluating a model
def run_test_harness():
	model = load_model('/content/drive/MyDrive/Colab Notebooks/FINALS/Models/weights-improvement-07-0.98.hdf5')
...
# Load saved model
saved_model = load_model("/content/drive/MyDrive/Colab Notebooks/FINALS/Models/weights-improvement-07-0.98.hdf5")

# Load sample image
image = cv2.imread("/content/drive/MyDrive/Colab Notebooks/FINALS/lights/chandelier/chandelier/image_0098.jpg")
...
image1 = cv2.imread("/content/drive/MyDrive/Colab Notebooks/FINALS/lights/lamp/lamp/image_0038.jpg")
